...
function drawChart() {
  ...
  dataTable.addRows([
    ...
    [ 'Next Gen Front-End', 'Avocat du diable', start(16, 09, 2022), start(06, 11, 2022) ],

    [ 'Performance Upgrade', 'Avocat du diable', start(14, 11, 2022), start(31, 12, 2022) ],

    [ 'User Management', 'Avocat du diable', start(01, 01, 2022), start(01, 03, 2022) ],

    [ 'Third Party Service', 'Avocat du diable', start(28, 6, 2022), start(17, 8, 2022) ],

    [ 'Content Design', 'Avocat du diable', start(14, 3, 2022), start(24, 4, 2022) ],

    [ 'NextGen Back-End', 'Avocat du diable', start(18, 4, 2022), start(8, 6, 2022) ],
  
    [ taskname , desc , start(16, 09, 2022), start(06, 11, 2022) ]
  ]);  
